		...
		<footer className='w-screen py-10 mt-24 bg-[#212529]'>
			<section className='w-full py-10 grid grid-cols-3 font-lora text-white justify-center'>
				<div className='mx-auto'>
					<h2 className='text-[14px] mb-2 md:text-[18px]'>Contact</h2>
					<ul>
						<li>info@blog.com</li>
				...
				<div className='mx-auto'>
					<h2 className='text-[14px] mb-2 md:text-[18px]'>Legal</h2>
					<ul>
						<li>Terms</li>
						<li>Privacy</li>
					</ul>
				...
				<div className='mx-auto'>
					<h2 className='text-[14px] mb-2 md:text-[18px]'>Connect</h2>
					<ul>
						<li>Facebook</li>
						<li>Twitter</li>
						<li>Instagram</li>
